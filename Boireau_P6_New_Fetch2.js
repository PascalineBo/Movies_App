...
function fetchDataByGenre(Genre){
    ...
    fetchDataByGenreByPage(URL_1,imageURLsList, Genre) // met les urls image de la première page dans une liste
    
    console.log(imageURLsList)
    
    //showSevenFirstMoviePics(Genre, imageURLsList, page = 0); // affiche les 7 premières images de la liste dans le carrousel
...
function fetchDataBestMovies() {
    ...
    fetch(URL_1)
            ...
            .then(data => {
                ...
                console.log("Best Movie URL List:" + imageURLsList)
                return imageURLsList
                }
            )
